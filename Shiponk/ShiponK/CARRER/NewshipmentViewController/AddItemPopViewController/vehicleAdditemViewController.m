//
//  vehicleAdditemViewController.m
//  ShiponK
//
...
@interface vehicleAdditemViewController ()<UINavigationControllerDelegate,UIImagePickerControllerDelegate,UITextFieldDelegate>
{
...
@implementation vehicleAdditemViewController
   ...
   vehicleType=YES;
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(AddItemNotification:)
                                                 name:@"AddItemForVehicleAdditemVC"
                                               object:nil];
...
//    }
    else
    {
       ...
       // NSData *data = UIImagePNGRepresentation(selectImg);
        ...
        NSString *vehicleTypeStr;
        if (vehicleType==NO) {
            
            vehicleTypeStr=[NSString stringWithFormat:@"Old"];
        }
        else{
            vehicleTypeStr=[NSString stringWithFormat:@"New"];
        }
        ...
        if(selectImg1==NULL && selectImg2==NULL && selectImg3==NULL && selectImg4==NULL)
        {
            ...
            dataDic = [NSMutableDictionary dictionaryWithObjectsAndKeys:[NSString stringWithFormat:@"%@",_txtItemTitle.text],@"title",[NSString stringWithFormat:@"%@",vehicleTypeStr],@"type",[NSString stringWithFormat:@"%@",strQty],@"quantity", nil];
            
        }
        else
        {
            
            dataDic = [NSMutableDictionary dictionaryWithObjectsAndKeys:[NSString stringWithFormat:@"%@",_txtItemTitle.text],@"title",[NSString stringWithFormat:@"%@",vehicleTypeStr],@"type",[NSString stringWithFormat:@"%@",strQty],@"quantity",dic,@"photo", nil];
...
- (IBAction)btnNewAction:(id)sender {
    ...
    if (vehicleType==NO) {
        vehicleType=YES;
             ...
             [_btnNew setImage:[UIImage imageNamed:@"check.png"] forState:UIControlStateNormal];
        [_btnOld setImage:[UIImage imageNamed:@"uncheck.png"] forState:UIControlStateNormal];
...
- (IBAction)btnOldAction:(id)sender {
    ...
    if (vehicleType==YES) {
        vehicleType=NO;
        [_btnOld setImage:[UIImage imageNamed:@"check.png"] forState:UIControlStateNormal];
        [_btnNew setImage:[UIImage imageNamed:@"uncheck.png"] forState:UIControlStateNormal];
