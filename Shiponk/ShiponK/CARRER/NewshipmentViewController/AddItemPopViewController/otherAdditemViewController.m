...
@interface otherAdditemViewController ()<UINavigationControllerDelegate,UIImagePickerControllerDelegate,UITextFieldDelegate>
{
...
@implementation otherAdditemViewController
...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(AddItemNotification:)
                                                 name:@"AddItemForotherAdditemVC"
                                               object:nil];
    
   // _mainScrollview.contentSize = CGSizeMake(200, 550);
    ...
    else
    {
       ...
       // NSData *data = UIImagePNGRepresentation(selectImg);
        ...
        if(selectImg1==NULL && selectImg2==NULL && selectImg3==NULL && selectImg4==NULL)
        {
            ...
            dataDic = [NSMutableDictionary dictionaryWithObjectsAndKeys:[NSString stringWithFormat:@"%@",_txtItemTitle.text],@"title",[NSString stringWithFormat:@"%@.%@",strWidthM,strWidthCM],@"width",[NSString stringWithFormat:@"%@.%@",strHeightM,strHeightCM],@"height",[NSString stringWithFormat:@"%@",strQty],@"quantity",[NSString stringWithFormat:@"%@",strWeight],@"weight", nil];
