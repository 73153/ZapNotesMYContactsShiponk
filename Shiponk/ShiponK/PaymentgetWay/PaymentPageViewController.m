...
#define Product_Info @"ShiponK"
#define Paid_Amount @"100.00"
#define Payee_Name @"Bhushan"
...
- (void)viewDidLoad {
    ...
    for (id subview in _webviewPaymentPage.subviews){
...
-(void)initPayment {
    ...
    amoutDueStr=[NSString stringWithFormat:@"%@",[objappShareManager.loginDic valueForKey:@"due_amount"]];
    
    NSString *amount = [NSString stringWithFormat:@"%@" ,amoutDueStr];
    NSString *productInfo = Product_Info;
    NSString *firstname = Payee_Name;
    NSString *email = [NSString stringWithFormat:@"bhushan%d@zaptechsolutions.com",i]; // Generated a fake mail id for testing
    NSString *phone = @"+918156006707";
...
- (void)delayedDidFinish:(NSString *)getStringFromUrl {
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        [mutDictTransactionDetails setObject:amoutDueStr forKey:@"Paid_Amount"];
