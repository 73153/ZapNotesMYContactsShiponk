//
//  Setting_customer_ViewController.m
//  CustomTableView
//
...
@interface Setting_customer_ViewController ()<SlideNavigationControllerDelegate>
{
    NSArray *array1,*array2,*array3,*array4;
}
@end

@implementation Setting_customer_ViewController
